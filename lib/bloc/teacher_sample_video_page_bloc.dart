...
class TeacherSampleVideoPageBloc extends ChangeNotifier{
  ...
  TeacherSampleVideoPageBloc(String teacherID, String categoryID, String courseID){
    _apply.getTeacherSampleVideoListStream(teacherID, categoryID, courseID).listen((event) {
